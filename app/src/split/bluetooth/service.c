...
#define SERVICE_STACK_SIZE 512
#define SERVICE_PRIORITY 5

K_THREAD_STACK_DEFINE(service_q_stack, SERVICE_STACK_SIZE);

struct k_work_q service_work_q;

#define POSITION_STATE_QUEUE_SIZE 10

K_MSGQ_DEFINE(position_state_msgq, sizeof(char[POS_STATE_LEN]), POSITION_STATE_QUEUE_SIZE, 4);
